...
fpath <- list(lad_output_rds = "data/processed/births_lad.rds",
              ...
              lad_yearly_by_month_output_rds = "data/processed/births_lad_rolling_12_month.rds",
              rgn_yearly_by_month_output_rds = "data/processed/births_rgn_rolling_12_month.rds",
              itl_yearly_by_month_output_rds = "data/processed/births_itl_rolling_12_month.rds",
              ctry_yearly_by_month_output_rds = "data/processed/births_ctry_rolling_12_month.rds",

              lad_yearly_by_month_output_csv = "data/processed/births_lad_rolling_12_month.csv",
              rgn_yearly_by_month_output_csv = "data/processed/births_rgn_rolling_12_month.csv",
              itl_yearly_by_month_output_csv = "data/processed/births_itl_rolling_12_month.csv",
              ctry_yearly_by_month_output_csv = "data/processed/births_ctry_rolling_12_month.csv",
